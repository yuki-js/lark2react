...
export function Heading1({ blockData, hash }) {
  return <Heading blockData={blockData} hash={hash} tag={1}></Heading>
}

export function Heading2({ blockData, hash }) {
  return <Heading blockData={blockData} hash={hash} tag={2}></Heading>
}

export function Heading3({ blockData, hash }) {
  return <Heading blockData={blockData} hash={hash} tag={3}></Heading>
}

export function Heading4({ blockData, hash }) {
  return <Heading blockData={blockData} hash={hash} tag={4}></Heading>
}

export function Heading5({ blockData, hash }) {
  return <Heading blockData={blockData} hash={hash} tag={5}></Heading>
}
